var cal = {
  ...
  // cal.list() : draw the calendar for the given month
    ...
    var startDay = new Date(cal.sYear, cal.sMth, 1).getDay() // first day of the month
    var endDay = new Date(cal.sYear, cal.sMth, daysInMth).getDay() // last day of the month
  ...
  // PARAM el : Reference back to cell clicked
    ...
    // DRAW FORM
    var tForm = '<h1>' + (cal.data[cal.sDay] ? 'EDIT' : 'ADD') + ' HABIT</h1>'
